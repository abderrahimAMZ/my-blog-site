...
const CarteBlog = ({title, fluid, author, date, time, author_github, slug, path}) => {
    ...
    return (
        <Link to={`${path}/${slug}`} className={"w-[270px]  dark:bg-dark-card  bg-gray-100 rounded-md dark:shadow-black dark:shadow-sm shadow-sm shadow-gray-300 transform hover:scale-110 grid grid-rows-subgrid mx-auto  "}>
                <div>
